...
const intro = magpieViews.view_generator("intro", {
    ...
    text:   `Welcome and thank you for joining our experiment on "mental rotation".`,
...
const instructions_practice = magpieViews.view_generator("instructions", {
    ...
    text:  `In the Experiment you are going to see two objects. Your task is to evaluate if they are the same, apart from rotation. For this you have to press either the "f" key to indicate that the objects are the same or the "j" key if they are different. Try answering as quickly and precisely as possible.
            <br />
            <br />
            We will start with a practice first.`,
